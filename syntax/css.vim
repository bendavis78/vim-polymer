...
" Paper Elements
syn match polymerPaperElement "paper-\(button\|checkbox\|dialog\|dropdown-menu\|fab\|icon-button\|input\|item\|menu-button\|progress\|radio-button\|radio-group\|ripple\|shadow\|slider\|tabs\|toast\|toggle-button\)"

" Custom Elements
syn match customElement "[a-z-]+"
